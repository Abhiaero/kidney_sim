...
*   **NumPy & SciPy:** Used for high-performance matrix operations and mathematical solving of the algebraic equations generated by discretization.
...
As the project evolves beyond the initial 2D analytical and FDM-based simulations, the following advanced options will be integrated for a more comprehensive industrial-grade analysis:
...
*   **Advanced Solvers:** Migrating from pure Python FDM/FVM solvers to robust finite element/volume frameworks like FEniCS, OpenFOAM, or commercial software (ANSYS Fluent/CFX) for handling highly complex 3D unstructured meshes and parallel computing capabilities.
